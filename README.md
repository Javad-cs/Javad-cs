...
- **Honorable Mention**, **IMO 2021 & 2022** (International Math Olympiad)  
- **NAACL 2025 (C3NLP)** accepted paper on multimodal cultural awareness  
- **Top 100 (out of 80,000)** – **Rise for the World Global Competition** (UK)

---

## 🛠️ Skills

**Languages**: Python, C, SQL, Java, Matlab, HTML/CSS, JavaScript, Flask  
**Frameworks**: PyTorch, TensorFlow, Hugging Face  
**Tools**: SAM, OpenCV, MySQL, Git, Docker  
**Human Languages**: Azerbaijani (native), English, Russian (fluent), Turkish (advanced), Korean & Spanish (basic)
...
- Applied research, product engineering, or backend systems
- Projects with real-world impact, innovation, or scale

📬 Let's connect!  
[📧 Email Me](mailto:javad.ism@kaist.ac.kr) • [💼 LinkedIn](https://www.linkedin.com/in/javadismayilzada)
